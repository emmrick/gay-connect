...
export const useMaintenanceMode = () => {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return data as { id: string; is_active: boolean; message: string | null; activated_at: string | null };
    },
...
export const useToggleMaintenance = () => {
  ...
  return useMutation({
    mutationFn: async ({ isActive, message }: { isActive: boolean; message?: string }) => {
