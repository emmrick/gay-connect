...
const navItems: NavItem[] = [
  ...
  { id: 'promo-images' as AdminSection, label: 'Visuels', icon: Sparkles, group: 'communication', adminOnly: true, permissionKey: 'can_manage_promo' },
  { id: 'site-updates' as AdminSection, label: 'Updates', icon: Rocket, group: 'communication', adminOnly: true, permissionKey: 'can_broadcast' },
